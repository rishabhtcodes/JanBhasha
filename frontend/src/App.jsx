...
function ProtectedRoute({ children, adminOnly = false }) {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center text-indigo-400">Loading JanBhasha...</div>;
    ...
    <div className="min-h-screen flex flex-col justify-between bg-slate-950 text-slate-100">
      ...
      <footer className="glass-panel border-t border-slate-800/80 py-8 mt-16 text-center text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 JanBhasha Indic AI Translation Platform. All rights reserved.</p>
          <div className="flex gap-4 font-semibold text-slate-400">
            <span>Vercel Hosted Frontend</span>
            <span>•</span>
            <span>Render Hosted Laravel REST API</span>
          </div>
        </div>
      </footer>
